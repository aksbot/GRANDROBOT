...
TECHNO_IMG = "https://te.legra.ph/file/28688a33be233e081721c.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/Akshaymh17")],
                                                                                   [InlineKeyboardButton(text="ADD Jarvis TO YOUR GROUP",
        ...
        update.effective_message.reply_text("Yuss, Jarvis Already ONline in bot owner 😏")
